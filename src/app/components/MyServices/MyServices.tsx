        ...
        <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
            <div className="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl">
                <div
                    ...
                    className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#ff4694] to-[#928881] opacity-20"
                />
            </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    <h2 className="text-base/7 font-semibold text-orange-600">Services</h2>
                    <h3 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl">At your service</h3>
                ...
                <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-8">
                    {services.map((service) => (
                        <div key={service.name} className="flex gap-x-4 rounded-xl bg-white/5 p-6 ring-1 ring-inset ring-white/10">
                            <service.icon aria-hidden="true" className="h-7 w-7 flex-none text-orange-500" />
